...
typedef NSInteger (^UIAlertViewCompletionBlockReult) (UIAlertView *alertView, NSInteger buttonIndex);
...
@property (copy, nonatomic) UIAlertViewCompletionBlockReult clikeBlock;
