...
static const void *UIAlertViewClikeBlockKey                           = &UIAlertViewClikeBlockKey;
...
- (UIAlertViewCompletionBlockReult)clikeBlock {
    return objc_getAssociatedObject(self, UIAlertViewClikeBlockKey);
}
- (void)setClikeBlock:(UIAlertViewCompletionBlockReult)tapBlock {
    [self _checkAlertViewDelegate];
    objc_setAssociatedObject(self, UIAlertViewClikeBlockKey, tapBlock, OBJC_ASSOCIATION_COPY);
}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    UIAlertViewCompletionBlockReult resultComp=alertView.clikeBlock;
    if (resultComp) {
        resultComp(alertView,buttonIndex);
    }
